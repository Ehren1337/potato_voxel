...
-- ------- deterministic noise (shared xorshift, lib/Noise.lua)
--
-- The generator needs a real 32-bit xor and a real 32-bit wrap, written
-- out in arithmetic rather than taken from LuaJIT's `bit` (see the note
-- in Noise.lua).
